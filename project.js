...
if (typeof window == "undefined") 
    {  
        Simulation = require('D:/New Folder/node_global/node_modules/cacatoo/dist/cacatoo.js') // Loads the Simulation class for nodejs-mode.     
    }
    //if (typeof window == "undefined") Simulation = require('cacatoo') // ... if you have cacatoo installed via npm install cacatoo. 

    //    let srand(time(NULL))
    let maxsteps = 10000 // 1 
    ...
    let cost_per_CG = 0.001 // Set the cost of producing each public good. 
    ...
    let diffuse_interval = 2 
    let prodiffuse_interval = 2 
    let consume_chance = 1 
    let consume_number = 1 
    let consume = 1 
    let decay_chance = 0.01 
    ...
    sim.dopple.writeGrid = function() {
       ...
       sim.cells.update = function () { // This is the third part of cacatoo, the main simulation loop. 
           ...
           // genotype = 0 
             ...
             if (this.time % write_out_interval == 0)       
            {
				sim.cells.writeProd() 
             ...
             if (this.time % (write_out_interval * 5) == 0)
                {
                    sim.cells.writeGrid()
                } 
